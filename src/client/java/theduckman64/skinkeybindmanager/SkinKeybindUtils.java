 ...
 * This class does not depend on any Minecraft or Fabric APIs.
 */
public class SkinKeybindUtils {
    ...
    public static Map<String, KeyData> decodePlayerSkin(BufferedImage skin, String variant) {
        ...
        if (dataLength <= 0 || dataLength > bytes.length - 4) {
            // No data found or data is corrupt
            return keybindMap;
        }
    ...
    public static BufferedImage downloadSkin(String username, String accessToken) throws Exception {
        String uuid = getProfileUUID(username);
        if (uuid == null) {
            throw new IOException("UUID not found for user: " + username);
        }
    ...
    public static String getVariant(String username, String accessToken) throws IOException {
        String uuid = getProfileUUID(username);
        if (uuid == null) {
            throw new IOException("UUID not found for user: " + username);
        }
    ...
    public static boolean uploadSkin(File skinFile, String slim, String accessToken) throws IOException {
